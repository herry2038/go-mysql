...
func TestMysqlUpdate(t *testing.T) {
	...
	Update("3E11FA47-71CA-11E1-9E33-C80AA9429562:21-58")

	assert.Equal(t, "3E11FA47-71CA-11E1-9E33-C80AA9429562:21-58", strings.ToUpper(String()))
}
...
func TestMysqlGTIDContain(t *testing.T) {
	...
	assert.True(t, Contain(g1))
	assert.False(t, Contain(g2))
}
